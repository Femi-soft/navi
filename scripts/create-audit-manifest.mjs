...
const files=[
  ...
  "ignition/modules/NaviBaseSepoliaCanary.ts",
  ...
  "apps/web/lib/server/canary.ts",
  "apps/web/app/api/execution/canary/status/route.ts",
  "apps/web/app/api/execution/canary/policy/route.ts",
  "apps/web/app/api/execution/canary/prepare/route.ts",
  "hardhat.config.ts",
  "package-lock.json",
